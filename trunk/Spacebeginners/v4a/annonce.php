...
<tr><th colspan="5">Appolonium</th><th colspan="5"><input type="texte" value="0" name="appoloniumvendre" /></th></tr>
...
<tr><th colspan="5">Appolonium</th><th colspan="5"><input type="texte" value="0" name="appoloniumsouhait" /></th></tr>
...
if(($metalvendre!=0 && $metalsouhait==0) ||($cristalvendre!=0 && $cristalsouhait==0) || ($deutvendre!=0 && $deutsouhait==0)|| ($appoloniumvendre!=0 && $appoloniumsouhait==0)){
doquery("INSERT INTO {{table}} SET user='{$users['username']}', galaxie='{$users['galaxy']}', systeme='{$users['system']}', metala='{$metalvendre}', cristala='{$cristalvendre}', deuta='{$deutvendre}', appolonium='{$appoloniumvendre}', metals='{$metalsouhait}', cristals='{$cristalsouhait}', deuts='{$deutsouhait}', appoloniums='{$appoloniumsouhait}'" , "annonce");

message ('Ihre Anzeige wurde aufgenommen!', 'Anzeigenstatus',"annonce.php");
}

else{
message ('Ihre Anzeige ist ung&uuml;ltig !', 'Anzeigenstatus',"annonce.php?action=1");
}
...
message ('Ihre Anzeige wurde gel&ouml;scht !', 'Anzeigenstatus',"annonce.php");
break;
...
<br>
<table width=\"600\">
<td class=\"c\" colspan=\"12\" align=\"center\"><font color=\"#FFFFFF\">Kleinanzeigen f&uuml;r Rohstoff Handel</font></td></tr>
<tr><th colspan=\"3\">Lieferort!</th><th colspan=\"4\">Angebotene Rohstoffe !</th><th colspan=\"4\">Ben&ouml;tigte Rohstoffe !</th><th>Aktion</th></tr>
<tr><th>Spieler</th><th>Galaxie</th><th>System</th><th>Metall</th><th>Kristall</th><th>Deuterium</th><th>Appolonium</th><th>Metall</th><th>Kristall</th><th>Deuterium</th><th>Appolonium</th><th>L&ouml;chen</th></tr>";
...
$page2 .= "<tr><th colspan=\"12\" align=\"center\"><a href=\"annonce.php?action=1\">Anzeige aufgeben!</a></th></tr>
</td>
</table>
</HTML>";
