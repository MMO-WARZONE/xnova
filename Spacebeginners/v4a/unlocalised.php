...
function GetStartAdressLink ( $FleetRow, $FleetType ) {
   global $lang;
	$Link  = "<a title='".$lang['link_ir']."' href=\"galaxy.php?mode=3&galaxy=".$FleetRow['fleet_start_galaxy']."&system=".$FleetRow['fleet_start_system']."\" ". $FleetType ." >";
...
function GetTargetAdressLink ( $FleetRow, $FleetType ) {
   global $lang;
	$Link  = "<a title='".$lang['link_ir']."' href=\"galaxy.php?mode=3&galaxy=".$FleetRow['fleet_end_galaxy']."&system=".$FleetRow['fleet_end_system']."\" ". $FleetType ." >";
