 ...
 *
 * @uses        Nova_Core_Bo_EntityAbstract
 *
 * @access      public
 * @author      gplanchat
 * @category    Nova
 ...
 */
class Nova_User_Model_Entity_Authentication
    extends Nova_Core_Bo_EntityAbstract
{
    public function _construct()
    {
        $this->_init('user/entity.authentication', 'user/entity.authentication.data-mapper');
    }

    public function loadByIdentity($identity, $websiteId = NULL)
    {
        $this->load('identity', $identity);
