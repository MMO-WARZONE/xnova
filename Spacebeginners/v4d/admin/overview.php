...
$Consulta                = mysql_fetch_row(doquery("SELECT COUNT(*) FROM {{table}}","users"));
$parse['Usersregs']      = $Consulta[0];
$Consulta                = mysql_fetch_row(doquery("SELECT COUNT(*) FROM {{table}}","errors"));
$parse['canterrores']    = $Consulta[0];
$Consulta                = mysql_fetch_row(doquery("SELECT COUNT(*) FROM {{table}}","banned"));
$parse['cantban']        = $Consulta[0];
$Consulta                = mysql_fetch_row(doquery("SELECT COUNT(*) FROM {{table}}","alliance"));
$parse['cantalis']       = $Consulta[0];
$Consulta                = mysql_fetch_row(doquery("SELECT COUNT(*) FROM {{table}} where planet_type='1'","planets"));
$parse['cantplan']       = $Consulta[0];
$Consulta                = mysql_fetch_row(doquery("SELECT COUNT(*) FROM {{table}} where planet_type='3'","planets"));
$parse['cantlunas']      = $Consulta[0];
$Consulta                = mysql_fetch_row(doquery("SELECT COUNT(*) FROM {{table}} ","fleets"));
$parse['cantfleets']     = $Consulta[0];
$Consulta                = mysql_fetch_row(doquery("SELECT COUNT(*) FROM {{table}} ","messages"));
$parse['cantmessa']      = $Consulta[0];
$Consulta                = mysql_fetch_row(doquery("SELECT COUNT(*) FROM {{table}} ","rw"));
$parse['cantbata']       = $Consulta[0];
...
$Bloc['state_vacancy']  = "Ja";
} else {
$Bloc['state_vacancy']  = "Nein";
}
