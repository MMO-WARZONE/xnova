...
<tr>
	...
	<th><a title="Vision_mensajes">Nachrichtenansicht</a></th>
	<th>
			<select name="vis_messages" size="1">
			<option value="1" {vis_mess_1}>Tipo 1</option>
			<option value="2" {vis_mess_2}>Tipo 2</option>
			</select>
	</th>
</tr><tr>
	<td class="c" colspan="2">{galaxyvision_options}</td>
</tr><tr>
	<th><a title="Vision_Galaxy">Galaxieansicht</a></th>
	<th>
			<select name="vis_galaxy" size="1">
			<option value="1" {vis_galaxy_1}>Tipo 1</option>
			<option value="2" {vis_galaxy_2}>Tipo 2</option>
			</select>
	</th>
</tr><tr>
...
<th>Hall of Fame benutzen</th>
<th><input type="checkbox" name="halloffame" id="halloffame" {checked}></th>
</tr>
<tr>
