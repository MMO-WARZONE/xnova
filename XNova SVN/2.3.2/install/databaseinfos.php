...
$QryTableSac         = "CREATE TABLE `{{table}}` ( ";
$QryTableSac        .= "`id` bigint(20) unsigned NOT NULL auto_increment, ";
$QryTableSac        .= "`name` varchar(50) character set latin1 collate latin1_general_ci default NULL, ";
$QryTableSac        .= "`fleet_id` text character set latin1 collate latin1_general_ci, ";
$QryTableSac        .= "`origen_id` text NOT NULL,";
$QryTableSac        .= "`galaxy` int(2) default NULL, ";
$QryTableSac        .= "`system` int(4) default NULL, ";
$QryTableSac        .= "`planet` int(2) default NULL, ";
$QryTableSac        .= "`type` int(1) NOT NULL, ";
$QryTableSac        .= "`invited` mediumtext NOT NULL, ";
$QryTableSac        .= "`accept` mediumtext NOT NULL, ";
$QryTableSac        .= "`deny` mediumtext NOT NULL, ";
$QryTableSac        .= "`time` varchar(11) NOT NULL, ";
$QryTableSac        .= "PRIMARY KEY  (`id`) ";
$QryTableSac        .= ") ENGINE=MyISAM;";
...
$QryTableSupp       .="  `subject` varchar(255) collate latin1_bin NOT NULL,";
$QryTableSupp       .="  `text` longtext collate latin1_bin NOT NULL,";
$QryTableSupp       .="  `status` int(1) NOT NULL,";
$QryTableSupp       .="  PRIMARY KEY  (`ID`)";
$QryTableSupp       .=") ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_bin AUTO_INCREMENT=1 ;";
...
$QryInsertConfig    .= "('VERSION'          	 , '2.3.2'), ";
$QryInsertConfig    .= "('update_version'        , '1'), ";
...
$QryInsertConfig    .= "('initial_fields'        , '240'), ";
$QryInsertConfig    .= "('COOKIE_NAME'           , 'New-Xnova'), ";
$QryInsertConfig    .= "('game_name'             , 'XnovaSvn'), ";
...
$QryInsertConfig    .= "('forum_url'             , 'http://nd-games.es/foro/' ), ";
$QryInsertConfig    .= "('adm_attack'         	 , '0' ), ";
$QryInsertConfig    .= "('debug'                 , '0'), ";
$QryInsertConfig    .= "('lang'                  , 'es'), ";
$QryInsertConfig    .= "('stat'                  , '1'), ";
$QryInsertConfig    .= "('stat_level'            , '2'), ";
$QryInsertConfig    .= "('stat_last_update'      , '1'), ";
$QryInsertConfig    .= "('stat_settings'         , '1000'), ";
$QryInsertConfig    .= "('stat_amount'           , '50'), ";
$QryInsertConfig    .= "('stat_update_time'      , '30'), ";
$QryInsertConfig    .= "('stat_flying'           , '1'), ";
$QryInsertConfig    .= "('information'           , ''), ";
$QryInsertConfig    .= "('publicidad'            , ''), ";
$QryInsertConfig    .= "('user_mail'             , ''), ";
$QryInsertConfig    .= "('pass_mail'             , ''), ";
$QryInsertConfig    .= "('port_mail'             , ''), ";
$QryInsertConfig    .= "('sec_mail'              , ''), ";
$QryInsertConfig    .= "('smtp_mail'             , ''), ";
$QryInsertConfig    .= "('act_mail'              , '0,0'), ";
$QryInsertConfig    .= "('captcha'               , '0'), ";
$QryInsertConfig    .= "('publicidad'            , '0') ";
$QryInsertConfig    .= ";";


$QryTablePlugins ="CREATE TABLE IF NOT EXISTS `{{table}}` (
  ...
  `page_plugins` int(1) NOT NULL DEFAULT '0',
  `pos_plugins`int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_plugins`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;";

$QryTableIpLog ="CREATE TABLE IF NOT EXISTS `{{table}}` (
...
$QryTableNews="CREATE TABLE IF NOT EXISTS `{{table}}` (
...
$QryTableErrors     .= "`error_page` mediumtext CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,";
$QryTableErrors     .= "`error_line` int(32) NOT NULL,";
...
$QryTableMessages   .= "`message_read` int(1) NOT NULL , ";
...
$QryTablePlanets    .= "`b_building` bigint(20) NOT NULL default '0', ";
...
$QryTablePlanets    .= "`b_hangar` bigint(20) NOT NULL default '0', ";
$QryTablePlanets    .= "`b_hangar_id` text character set latin1 NOT NULL, ";
$QryTablePlanets    .= "`b_hangar_plus` bigint(20) NOT NULL default '0', ";
...
$QryTableRw         .= "`owners` varchar(255) character set latin1 collate latin1_general_ci NOT NULL default '0',";
...
$QryTableUsers      .= "`user_lastlogin` int(11) NOT NULL, ";
...
$QryTableUsers      .= "`activate_status` int(11) NOT NULL default '0' ";
