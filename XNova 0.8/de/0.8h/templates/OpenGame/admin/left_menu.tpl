...
<tr>
	...
	<td><div><a href="XNovaResetUnivers.php" target="{mf}" class="Stil1" accesskey="e"><strong><blink>{adm_reset}</blink></strong></a></div></td>
</tr><tr>
	...
	<td><div><a href="inactiv.php" accesskey="v" target="{mf}">{adm_inactiv}</a></div></td>
</tr><tr>
