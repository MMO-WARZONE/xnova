...
function f(target_url,win_name) {
  var new_win = window.open(target_url,win_name,'resizable=yes,scrollbars=yes,menubar=no,toolbar=no,width=550,height=290,top=0,left=0');
  new_win.focus();}</script>
...
<tr>
	<th colspan="3"><font color="gold"><div id="dateheure"></div></font></th>
</tr><tr>
	...
	<td colspan="2" background="{dpath}img/bg1.gif"><center><font color="lime">{ueber}</font></center></td>
</tr><tr>
	...
	<td colspan="2" background="{dpath}img/bg1.gif"><center><font color="lime">{devlp}</font></center></td>
</tr><tr>
	...
	<td colspan="2" background="{dpath}img/bg1.gif"><center><font color="lime">{handel}</font></center></td>
</tr><tr>	
    <td colspan="2"><div><a href="schrotti.php" accesskey="d" target="{mf}">{schrotti}</a></div></td>	
</tr><tr>
{marchand_link}
</tr><tr>
{announce_link}
</tr><tr>
	<td colspan="2" background="{dpath}img/bg1.gif"><center><font color="lime">{navig}</font></center></td>
</tr><tr>
	...
	<td colspan="2" background="{dpath}img/bg1.gif"><center><font color="lime">{observ}</font></center></td>
</tr><tr>
    ...
    <td colspan="2"><div><a href="actualisation.php"accesskey="c" target="{mf}"><font color="yellow">{actualisation}</font></a></div></td>
</tr><tr>
	...
	<td colspan="2" background="{dpath}img/bg1.gif"><center><font color="lime">{commun}</font></center></td>
</tr><tr>
...
{notes_link}
	...
	<td colspan="2"><div><a href="simulator.php" accesskey="1" target="fenster">Kampfsimulator</a></div></td>
</tr><tr>
...
<tr>
	...
	<td colspan="2" background="{dpath}img/bg1.gif"><center><font color="lime">{infog}</font></center></td>
</tr>
	{server_info}
<tr>
