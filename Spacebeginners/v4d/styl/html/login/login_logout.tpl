...
<center><table style='width:100%' cellspacing='0' >
    <tr><td align='center' >
        ...
        <table style='width:300px' cellspacing="0" >
            <tr><td class='c' style='width:50%' align='center' ><a href="login.php?page=regel">{logout_1002}</a></td>
                <td class='c' style='width:50%' align='center' ><a href="{forum_url}" target='_blank'>{logout_1003}</a></td></tr>
        </table><img src='./styl/image/login/menu_55.png' style='width:300px; height:10px;' alt=''>
...
<center>
<img src='./styl/image/login/menu_54.png' style='width:300px; height:10px;' alt=''><table cellpadding='0' cellspacing='0' style='width:300px;'>
