...
function calcul() {
	...
	var Appolonium = Metal + Cristal + Deuterium;
	document.getElementById("appolo").innerHTML=Appolonium;

	if (isNaN(document.forms['marchand'].elements['metal'].value)) {
		document.getElementById("appolo").innerHTML="{mod_ma_nbre}";
	}
...
<input type="hidden" name="ress" value="appolonium">
<table width="569">
<tr>
