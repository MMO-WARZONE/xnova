...
include($xnova_root_path . 'common.' . $phpEx);
	...
	if   ($MyGameLevel > $protectiontime AND
		$HeGameLevel < $protectiontime AND
		$protectiontime > 0){
			if ($_POST['mission'] == 1 or $_POST['mission'] == 5 or $_POST['mission'] == 6){
				message("<font color=\"lime\"><b>".$lang['fl_noob_mess_n2']."</b></font>", $lang['fl_noob_title'], "fleet." . $phpEx, 2);
			}
	}
	...
	if   ($MyGameLevel < $protectiontime AND
		...
		$protectiontime > 0){
			if ($_POST['mission'] == 1 or $_POST['mission'] == 5 or $_POST['mission'] == 6){
				message("<font color=\"red\"><b>".$lang['fl_pro_mess_n2']."</b></font>", $lang['fl_pro_title'], "fleet." . $phpEx, 2);
			}
	}
	...
	if (($MyGameLevel * $protectionmulti) < $HeGameLevel AND
		...
		$_POST['mission']     == 1  AND
		$protectionmulti      >  0) {
		message("<font color=\"red\"><b>".$lang['fl_pro_mess_n']."</b></font>", $lang['fl_pro_title'], "fleet." . $phpEx, 2);
	}
	...
	// ecriture de l'enregistrement de flotte (a partir de lï¿½, y a quelque chose qui vole et c'est toujours sur la planete d'origine)
	...
	// Mise a jours de l'enregistrement de la planete de depart (a partir de lÃ , y a quelque chose qui vole et ce n'est plus sur la planete de depart)
	doquery("LOCK TABLE {{table}} WRITE", 'planets');
	doquery ($QryUpdatePlanet, "planets");
	doquery("UNLOCK TABLES", '');
//	doquery("FLUSH TABLES", '');

	// Un peu de blabla pour l'utilisateur, affichage d'un joli tableau de la flotte expediï¿½e
	$page  = "<br><div><center>";
