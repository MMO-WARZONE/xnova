...
<tr>
	...
	<td class="k">{appolonium_basic_income}</td>
...
<tr>
	...
	<td class="k">{appolonium_total}</td>
...
<tr>
	...
	<th>{Appolonium}</th>
	<th>{daily_appolonium}</th>
	<th>{weekly_appolonium}</th>
	<th>{monthly_appolonium}</th>
</tr>
</tbody>
</table>
<br>
...
<tr>
	...
	<th>{Appolonium}</th>
	<th>{appolonium_storage}</th>
	<th width="250">
		<div style="border: 1px solid rgb(153, 153, 255); width: 250px;">
		<div id="AlmABar" style="background-color: {appolonium_storage_barcolor}; width: {appolonium_storage_bar}px;">
		&nbsp;
		</div>
		</div>
	</th>
