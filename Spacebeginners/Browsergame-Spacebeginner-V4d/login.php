...
if  ($game_config['game_disable'] == '1'){
    ...
    switch($_GET[page]){
        ...
        $page = parsetemplate(gettemplate('login/login_regeln'), $parse);
        display ($page, $lang['Regeln'], false);
        ...
        if ($_POST) {
            ...
            if ($login) {
                ...
                if ($login['password'] == md5($_POST['password'])) {
                    ...
                    unset($dbsettings);
                    header("Location: ./game.php?page=Space-Beginners");
                    exit;
                } else {
