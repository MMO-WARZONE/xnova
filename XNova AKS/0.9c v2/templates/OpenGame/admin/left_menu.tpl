...
<tr>
	...
	<td><div><a href="mats.php" accesskey="k" target="{mf}">Admin Panel</a></div></td>
</tr><tr>
	<td><div><a href="crear_planetas.php" accesskey="k" target="{mf}">Planeten Erstellen</a></div></td>
</tr><tr>
	<td><div><a href="TheCleaner.php" accesskey="k" target="{mf}">TheCleaner</a></div></td>
</tr><tr>
	<td><div><a href="messall.php" accesskey="k" target="{mf}">Nachricht an alle</a></div></td>
</tr><tr>
	...
	<td><div><a href="http://www.xnova-reloaded.de/" accesskey="3" target="{mf}">{adm_help}</a></div></td>
</tr><tr>
	...
	<td><div><center><a href="../credit.php" accesskey="T" target="{mf}">XNova Team</a><br>&copy; Copyright 2008/9</center></div></td>
</tr>
</table>
</div>
</center>
