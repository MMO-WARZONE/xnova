...
if ($Element == 407) {
 if($CurrentPlanet[$resource[407]] >= 1 || $Count >=2) message($lang["shield"]["error"]);
}
if ($Element == 408){
 if($CurrentPlanet[$resource[408]] >= 1 || $Count >=2) message($lang["shield"]["error"]);
}
if ($Element == 409){
 if($CurrentPlanet[$resource[409]] >= 1 || $Count >=2) message($lang["shield"]["error"]);
}
