...
<tr>
	...
	<td colspan="2" background="{dpath}img/bg1.gif"><center>{Building}</center></td>
</tr><tr>
	...
	<td colspan="2" background="{dpath}img/bg1.gif"><center>{Wirt}</center></td>
</tr><tr>
	...
	<td colspan="2" background="{dpath}img/bg1.gif"><center>{Alli}</center></td>
</tr><tr>
	...
	<td colspan="2"><div><a href="notes.php" accesskey="n" target="{mf}">{Notes}</a></div></td>
</tr><tr>
...
<tr>
	...
	{server_info}
<tr>
	<td colspan="2"><div><center><a href="credit.php" accesskey="T" target="{mf}">XNova-Germany</a><br>&copy; Copyright 2009</center></div></td>
</tr>
</table>
</div>
</center>
