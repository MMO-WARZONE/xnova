...
include($ugamela_root_path . 'common.' . $phpEx);
	...
	if ($who == 2) {
		...
		while ($StatRow = mysql_fetch_assoc($query)) {
			...
			$parse['player_mes']      = "<a href=\"messages.php?mode=write&id=" . $UsrRow['id'] . "\"><img src=\"" . $dpath . "img/m.gif\" border=\"0\" alt=\"". $lang['message'] ."\" /></a>
																	 <a href=\"buddy.php?a=2&amp;u=" . $UsrRow['id'] . "\"><img src=\"" . $dpath . "img/b.gif\" border=\"0\" alt=\"". $lang['buddy'] ."\" /></a>";
