...
<tr>
	<th colspan="2"><input type="reset" value="Loechen" /></th>
</tr><tr>
	<th colspan="2"><input type="submit" value="Senden" size="20" style="font-weight:bold" onClick="this.form.submit();this.disabled=true;this.value='Warten...'"/></th>
</tr><tr>
