...
function InsertBuildListScript ($CallProgram)
{
	...
	$BuildListScript .= "			}\n";
        $BuildListScript .= "			if ( h > 23 ) {\n";
	$BuildListScript .= "				d = Math.floor( h / 24);\n";
	$BuildListScript .= "				h = h - d * 24;\n";
	$BuildListScript .= "			}\n";
	...
	$BuildListScript .= "			}\n";
        $BuildListScript .= "			if ( d < 1 ) {\n";
	$BuildListScript .= "				d = \"\" ;\n";
	$BuildListScript .= "			}else{\n";
        $BuildListScript .= "				d = d + \"d \" ;\n";
	$BuildListScript .= "			}\n";
        $BuildListScript .= "			if (1) {\n";
	$BuildListScript .= "				blc.innerHTML =d  + h + \":\" + m + \":\" + s + \"<br><a href=game.php?page=". $CallProgram ."&listid=\" + pk + \"&cmd=\" + pm + \"&planet=\" + pl + \">".$lang['bd_cancel']."</a>\";\n";
	$BuildListScript .= "			} else {\n";
	$BuildListScript .= "				blc.innerHTML =d  + h + \":\" + m + \":\" + s + \"<br><a href=game.php?page=". $CallProgram ."&listid=\" + pk + \"&cmd=\" + pm + \"&planet=\" + pl + \">".$lang['bd_cancel']."</a>\";\n";
	$BuildListScript .= "			}\n";
	$BuildListScript .= "		}\n";
