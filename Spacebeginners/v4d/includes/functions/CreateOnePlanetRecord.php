...
function CreateOnePlanetRecord($Galaxy, $System, $Position, $PlanetOwnerID, $PlanetName = '', $HomeWorld = false) {
        ...
        if (!$PlanetExist) {
				...
				$planet['appolonium']        = BUILD_APPOLONIUM;
                ...
                if ($Position == 1 || $Position == 2 || $Position == 3) {
                        ...
                        $PlanetType         = array('dschjungel', 'gas', 'normaltemp', 'trocken', 'wasser', 'eis');
                        $PlanetClass        = array('planet');
                        $PlanetDesign       = array('01', '02', '03', '04', '05', '06', '07', '08', '09', '10');
                ...
                $QryInsertPlanet .= "`appolonium` = '".           $planet['appolonium']          ."', ";
                $QryInsertPlanet .= "`appolonium_perhour` = '".   $planet['appolonium_perhour']  ."', ";
                $QryInsertPlanet .= "`appolonium_max` = '".       $planet['appolonium_max']      ."';";
