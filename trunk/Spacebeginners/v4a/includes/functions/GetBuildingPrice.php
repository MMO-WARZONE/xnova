...
function GetBuildingPrice ($CurrentUser, $CurrentPlanet, $Element, $Incremental = true, $ForDestroy = false, $total = false) {
	...
	$array = array('metal', 'crystal', 'deuterium', 'appolonium', 'energy_max');
	$tcost = 0;
