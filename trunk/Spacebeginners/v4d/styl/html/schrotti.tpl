...

{
	...
	var regain_appol = {schrotti_appol};
	...
	document.getElementById('schrotti_appol').innerHTML = num * regain_appol;
}
	...
	<form action="" method="post">
     <tr height="20">
         ...
         <td colspan="2" class="c" align="left">
          ...
          <input id="numschrotti" type="text" name="number_ships_sell" alt="{Kleiner_transporter}" size="12" maxlength="12" value="0" tabindex="1" onKeyup="calc_resources();">
     ...
     {Merchant_give_Metall}<br>
     {Merchant_give_Kristall}<br>
	 {Merchant_give_Deuterium}<br>
     {Merchant_give_Appolonium}</td>
     </td>
