...
<tr><th height="22">{officier_bonus}</th>
	<td class="k">{metal_offi}</td>
	<td class="k">{crystal_offi}</td>
	<td class="k">{deuterium_offi}</td>
	<td class="k">{energy_offi}</td><td class="k"></td>
</tr><tr>
...
<tr>
	...
	<td class="k">{energy_total}/{energy_max}</td><td class="k"></td>
</tr>
</tbody>
</table>
</form>
