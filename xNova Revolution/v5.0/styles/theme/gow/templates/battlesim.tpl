...
<tr><td class="c" style="text-align:center;">{$bs_steal} {$Metal}: <input type="text" size="10" value="{if $battleinput.0.1.1}{$battleinput.0.1.1}{else}0{/if}" name="battleinput[0][1][1]"> {$Crystal}: <input type="text" size="10" value="{if $battleinput.0.1.2}{$battleinput.0.1.2}{else}0{/if}" name="battleinput[0][1][2]"> {$Deuterium}: <input type="text" size="10" value="{if $battleinput.0.1.3}{$battleinput.0.1.3}{else}0{/if}" name="battleinput[0][1][3]"> {$Norio}: <input type="text" size="10" value="{if $battleinput.0.1.4}{$battleinput.0.1.4}{else}0{/if}" name="battleinput[0][1][4]"></td></tr>
