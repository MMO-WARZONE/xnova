...
*/
        ...
        $page .= "<input type=\"hidden\" name=\"thisresource1\"  value=\"". abs($planetrow["metal"]) ."\" />\n";
        $page .= "<input type=\"hidden\" name=\"thisresource2\"  value=\"". abs($planetrow["crystal"]) ."\" />\n";
        $page .= "<input type=\"hidden\" name=\"thisresource3\"  value=\"". abs($planetrow["deuterium"]) ."\" />\n";
		$page .= "<input type=\"hidden\" name=\"thisresource4\"  value=\"". abs($planetrow["appolonium"]) ."\" />\n";
        ...
        $page .= "<th><input name=\"resource1\" value=\"". $null ."\"alt=\"". $lang['Metal'] ." ". abs($planetrow["metal"]) ."\" size=\"14\" onchange=\"calculateTransportCapacity();\" type=\"text\"></th>\n";
        $page .= "</tr><tr height=\"20\">\n";
        $page .= "<th>". $lang['Crystal'] ."</th>\n";
        $page .= "<th><a href=\"javascript:maxResource('2');\">". $lang['fl_selmax'] ."</a></th>\n";
        $page .= "<th><input name=\"resource2\"value=\"". $null ."\" alt=\"". $lang['Crystal'] ." ". abs($planetrow["crystal"]) ."\" size=\"14\" onchange=\"calculateTransportCapacity();\" type=\"text\"></th>\n";
        $page .= "</tr><tr height=\"20\">\n";
        $page .= "<th>". $lang['Deuterium'] ."</th>\n";
        $page .= "<th><a href=\"javascript:maxResource('3');\">". $lang['fl_selmax'] ."</a></th>\n";
        $page .= "<th><input name=\"resource3\"value=\"". $null ."\" alt=\"". $lang['Deuterium'] ." ". abs($planetrow["deuterium"]- $consumption) ."\" size=\"14\" onchange=\"calculateTransportCapacity();\" type=\"text\"></th>\n";
        $page .= "</tr><tr height=\"20\">\n";
	    $page .= "<th>". $lang['Appolonium'] ."</th>\n";
        $page .= "<th><a href=\"javascript:maxResource('4');\">". $lang['fl_selmax'] ."</a></th>\n";
        $page .= "<th><input name=\"resource4\"value=\"". $null ."\" alt=\"". $lang['Appolonium'] ." ". abs($planetrow["appolonium"]) ."\" size=\"14\" onchange=\"calculateTransportCapacity();\" type=\"text\"></th>\n";
        $page .= "</tr><tr height=\"20\">\n";
        ...
        if ($planet == 16) {
                ...
                $page .= "<option value=\"16\">16</option>";
                $page .= "<option value=\"32\">32</option>";
				$page .= "<option value=\"64\">64</option>";
                $page .= "</select>";
                $page .= $lang['fl_expe_hours'];
                $page .= "</th>";
                $page .= "</tr>";
