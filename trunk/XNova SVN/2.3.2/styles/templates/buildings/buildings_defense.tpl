    ...
    {message}
        <form action="" method="post">
            <table align="top" width="600">
                <tr>
                <!-- START BLOCK : buildlist -->
                <td class="l">
                    <table align="center" border = "0" width="200px" valign="top" >
                     <tr height="80px">
                         <td class="l" align="left" width="80" valign="top"  onclick="window.location.href='game.php?page=infos&gid={i}'" style="background-image: url({dpath}gebaeude/{i}.gif)" onmouseover="return overlib('<center><font size=1 color=white><b>{descripcion}</b></font></a></center>', RIGHT, WIDTH, 150);" onmouseout="return nd();">
