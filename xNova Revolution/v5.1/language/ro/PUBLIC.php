...
$LNG['server_description']		= '<strong>%s</strong> este un joc de strategie in spatiu. Competitie cu jucători 24h/zi 7/zile din săptămană pentru cucerirea universului. ot ceea ce ai nevoie este un navigator standard (<a class="" href="http://www.mozilla.com" target="_blank">Recomendamos Firefox</a>).';
...
$LNG['welcome_message_content']	    = 'Bine ai venit la %s!<br>Construieste intai pentru inceput primul nivel al centralei electrice, pentru că energia este necesară pentru o productie in viitor de materii prime. Pentru asta, fă click in Edificii din meniul stanga. Cand aceast este gata, poti incepe constructia minelor. Mergi inapoi in meniul Edificiilor si construieste o mină de metal, si apoi o mină de cristal. Echipa noastră vă doreste distractie placută in explorarea universului!';
...
03:02:01 În cazul în care fiecare unitate de deuteriu este în valoare de 2 unităţi de cristal sau 3 unităţi sau metal.

02:01:01 În cazul în care fiecare unitate de deuteriu este în valoare de 1 unităţi de cristal sau 2 unităţi de metal.
",
