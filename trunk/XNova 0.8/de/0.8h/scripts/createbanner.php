...
if (isset($id)) {
   ...
   // Querys
	$MaxUsers = doquery ("SELECT COUNT(*) AS `count` FROM {{table}} WHERE `db_deaktjava` = '0' OR `db_deaktjava` = '1';", 'users', true); // anzahl der registrierten usern
   ...
   $b_lvl= "".$lang['ov_pts_rang'] ." ". $Stats['total_rank']."/". $MaxUsers['count']."";
